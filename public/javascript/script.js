...
function GetCreateEventParticipantMap() {
	var map = new Microsoft.Maps.Map('#event-participant-map', {
		showDashboard: false,
		showTermsLink: false,
		showBreadcrumb: false,
		enableClickableLogo: false,
	...
	getLocationFromMap(map, function (lat, long) {
		console.log(lat, long)
		$('#eventPartLocLat').val(lat)
		$('#eventPartLocLat').val(long)
	})
